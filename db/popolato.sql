...
--
-- Host: 127.0.0.1
-- Creato il: Mag 21, 2024 alle 14:04
...
CREATE DATABASE IF NOT EXISTS `minionswallet` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `minionswallet`;
...
CREATE TABLE `conto` (
  ...
  `data_apertura` date DEFAULT current_timestamp(),
...
INSERT INTO `conto` (`id`, `nome_conto`, `data_apertura`, `sigla`) VALUES
(2, 'pettamoney', '2024-05-21', 'EUR');
...
('petto', 'petto@pettalove.it', 'pettofregnocotoettato', 2);
